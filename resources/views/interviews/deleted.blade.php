...
@section('title', 'Deleted Job Interviews | Wananchi Group HR Recruitment')
...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Deleted Job Interviews</h3>
    </div>
                    ...
                    <tr>
                        ...
                        btn-sm"><i class="fa fa-eye"></i></a>
                            ...
                            <a class="btn btn-danger btn-sm disabled" title="Delete Job Interview" href="#"
                                data-toggle="modal" data-target="#modal_delete_job_{{$item->interview_id}}"
                            ...
                            <a class="btn btn-danger btn-sm" title="Delete Job Interview" href="#" data-toggle="modal"
                                data-target="#modal_delete_job_{{$item->interview_id}}" data-backdrop="static"
