<div class="modal fade" id="modal_close_session_{{ $interviews->interview_id }}">
    <div class="modal-dialog">
        <div class="modal-content">
            {!!
            Form::open(['action'=>['InterviewsController@closeSession',$interviews->interview_id],'method'=>'POST','class'=>'floatit','enctype'=>'multipart/form-data'])
            !!}
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <p>Are you sure you want to close the interview session <span
