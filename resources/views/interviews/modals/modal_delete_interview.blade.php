<div class="modal fade" id="modal_delete_interview_{{ $item->interview_id }}">
    <div class="modal-dialog">
        <div class="modal-content">
            {!!
            Form::open(['action'=>['InterviewsController@destroy',$item->interview_id],'method'=>'POST','class'=>'floatit','enctype'=>'multipart/form-data'])
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title">Delete Job Interview</h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <p>Are you sure you want to delete <span
                                style="font-weight:bold">{{$item->interview_name}}</span>?
                        </p>
                    </div>
                </div>
            </div>
