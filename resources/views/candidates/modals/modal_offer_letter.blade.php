<div class="modal fade" id="modal_offer_letter_{{ $candidates->candidate_id }}">
    <div class="modal-dialog">
        <div class="modal-content">
            {!!
            Form::open(['action'=>['CandidateController@offerLetter',$candidates->candidate_id],'method'=>'POST','class'=>'floatit','enctype'=>'multipart/form-data'])
            !!}
