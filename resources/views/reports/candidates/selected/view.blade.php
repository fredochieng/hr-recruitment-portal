...
@section('title', 'Selected Candidates Report | Wananchi Group HR Recruitment')
        ...
        <div class="box box-info" id="accordion">
            ...
            <div id="collapseFilter" class="panel-collapse active collapse in" aria-expanded="true">
                <div class="box-body">
                    ...
                    <div class="col-md-2">
                        <a href="/reports/candidates/selected" style="margin-top:25px;"
    ...
    <div class="box box-info">
        <div class="box-body">
            <div class="table-responsive">
                <div class="box-header with-border">
                    <h3 class="box-title">
                        <b>Selected candidates Report For Period</b>
