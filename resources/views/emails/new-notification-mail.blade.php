                                                    ...
                                                    <table border="0" width="100%" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="text center-text" valign="middle" align="left"
                                                                ...
                                                                Hello {{ $panelist_name }},<br /><br />

                                                                {{ $body }}<br />

                                                                {{-- You can login to <a href="legal.wananchi.com"
                                                                    style="color:blue">Wananchi HR Recruitment
                                                                    Portal</a> to view the message.<br /><br /> --}}

                                                                Best regards,<br />
                                                                Wananchi Human Resource Department <br /> <br />
